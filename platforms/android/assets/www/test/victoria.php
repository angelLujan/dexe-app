		...
		<div class="container center">
			...
			<div class="row models-container">
				<div class="col-sm-4">
					...
					<a class="center-block purple-btn" href="pdf/victoria/cambridge.pdf">Ver PDF</a>
				</div>
				<div class="col-sm-4">
					<img class="no-drag" src="img/index/modelos/oxford.png" alt="Oxford">
					<h2 class="title green">OXFORD</h2>
					<p class="text-content">Terreno 120 m2 / Const. 166 m2</p>
					<a class="center-block green-btn" href="pdf/victoria/oxford.pdf">Ver PDF</a>
				</div>
				<div class="col-sm-4">
					<img class="no-drag" src="img/index/modelos/sheffield.png" alt="Sheffield">
					<h2 class="title orange">SHEFFIELD</h2>
					<p class="text-content">Terreno 120 m2 / Const. 166 m2</p>
					<a class="center-block orange-btn" href="pdf/victoria/sheffield.pdf">Ver PDF</a>
				</div>
			</div>
		</div>
	</div>

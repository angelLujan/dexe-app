...
<div class="nosotros container spacing center" id="nosotros">
	...
	<p class="text-content">Estamos comprometidos con la comunidad y el planeta. Consecuencia de lo anterior, somos una empresa de elevada rentabilidad conforme a los parámetros de la industria y una fuente de creación de valor para nuestros clientes, proveedores, colaboradores, comunidad y accionistas.</p>
</div>
...
<div class="parallax-container" id="descargar">
	...
	<div class="container transform-center-vertical center">
		...
		<div class="container">
			<div class="col-sm-6">
				<a href="http://mixen.mx/web/dexe/apk/dexe.apk" class="download-btn center-block googlePlay"></a>
			</div>
			<div class="col-sm-6">
	...
	<div class="row">
		<div class="col-sm-4">
			...
			<p class="contact-text">
				...
				<a href="mailto:info@dexe.com">info@dexe.com</a>
			</p>
		</div>

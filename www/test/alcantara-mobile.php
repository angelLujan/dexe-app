...
<div class="wrapper fraccionamiento alcantara">
	...
	<div class="container center spacing">
		<h1 class="title green">PUENTE DE ALCÁNTARA</h1>
		...
		<div class="container center">
			...
			<div class="row models-container">
				<div class="col-sm-6">
					...
					<p class="text-content">Terreno 120 m2 / Const. 123 m2</p>
					<a class="center-block purple-btn navLink" href="#" data-url="http://mixen.mx/web/dexe/pdf/alcantara/cadiz.pdf">Ver PDF</a>
				</div>
				<div class="col-sm-6">
					<img class="no-drag" src="img/index/modelos/orange.png" alt="VIGO">
					<h2 class="title orange">VIGO</h2>
					<p class="text-content">Terreno 120 m2 / Const. 153 m2</p>
					<a class="center-block orange-btn" href="http://mixen.mx/web/dexe/pdf/alcantara/vigo.pdf" onclick="window.open('http://mixen.mx/web/dexe/pdf/alcantara/vigo.pdf', '_self', 'location=yes')">Ver PDF</a>
				</div>
			</div>
		</div>
	</div>
...
<!-- VIDEO -->
	...
	<div class="map" id="googleMap" fracc="alcantara"></div>
</div>
